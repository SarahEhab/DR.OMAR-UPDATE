...
const initialState = {
  ...
  const getAllEldersFavorite = createAsyncThunk('get/AllEldersFavorite', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          'https://tsquarehost.info/public/api/Favorite/Get_Favorite_Elder');
  ...
  const getPicturesFavorite = createAsyncThunk('get/AllPicturesFavorite', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          'https://tsquarehost.info/public/api/Favorite/Get_Favorite_image');
        return response.data;
      } catch (error) {
        return error
      }
  ...
  const getBooksFavorite = createAsyncThunk('get/AllBooksFavorite', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          'https://tsquarehost.info/public/api/Favorite/Get_Favorite_Books');
        return response.data;
      } catch (error) {
        return error
      }
  ...
  const getAudiosFavorite = createAsyncThunk('get/AllAudiosFavorite', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          'https://tsquarehost.info/public/api/Favorite/Get_Favorite_Audios');
        return response.data;
      } catch (error) {
        return error
      }
