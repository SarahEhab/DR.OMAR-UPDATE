...
const initialState = {
    ...
    const getArticles = createAsyncThunk('get/articles', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          `https://tsquarehost.info/public/api/Articles/Get`);
    ...
    const getArticleCategory = createAsyncThunk('get/artical-category', async (_, thunkAPI) => {
      try {
        const response = await axios.get(
          `https://tsquarehost.info/public/api/Articles-Categories/Get`);
        return response.data;
      } catch (error) {
        return error
      }
    ...
    const getArticleCategoryById = createAsyncThunk('get/category-id', async (id, thunkAPI) => {
      try {
        const response = await axios.post(
          `https://tsquarehost.info/public/api/Articles-Categories/Get-Articles-From-Category?id=${id}`);
          console.log(response.data);
        return response.data;
      } catch (error) {
        return error
    ...
    const getArticleCategoryOne = createAsyncThunk('get/category-one-id', async (id, thunkAPI) => {
      try {
        const response = await axios.post(
          `https://tsquarehost.info/public/api/Articles/Get-id?id=${id}`);
          console.log(response.data);
        return response.data;
      } catch (error) {
        return error
