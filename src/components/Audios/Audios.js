  ...
  return (
    <>
      ...
      <Container className="d-flex justify-content-center align-items-center">
        <Row className="m-3 d-flex" style={{ justifyContent: "center" }}>
          <Col
            xs="6"
            md="4"
            lg="2"
            style={{ textAlign: "center", marginBottom: "10px" , display:'flex', justifyContent:'center', alignItems:'center',margin:'1px 10px'}}
          >
            <div
              style={{
                border: "none",
              ...
              <>
                {audioCategory.map((item, index) => (
                  <Col
                    ...
                    md="4"
                    lg="2"
                    style={{ textAlign: "center", marginBottom: "10px" , display:'flex', justifyContent:'center', alignItems:'center', margin:'0px 10px'}}
                  >
                    <Link
                      style={{
