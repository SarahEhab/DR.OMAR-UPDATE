            ...
            ? getAll && getAll.length > 0
              ? getAll.map((item) => {
                  ...
                  return (
                    ...
                    //             <div class="p-3">
                    //                 <div key={item.id}>
                    //                   <img src={item.image} alt='pic' width={200} height={200} className='img-audio-sort'/>
                    ...
                    <div className="col-lg-2 col-md-4 col-sm-6">
                      <div className="row">
                        ...
                        <div className="col-lg-8 col-md-8 col-sm-12 pt-2  ">
                            <h5 className="text-center p-2">{item.elder.name}</h5>
